    ...
    <section v-if="resultadoImportacao" class="sheet-card">
      <div class="sheet-body">
        <div class="section-head">
          ...
          <span class="badge badge-green">{{ resultadoImportacao.importados }} novos</span>
        </div>
      ...
      <div class="sheet-body">
        ...
        <div v-else class="mei-grid">
          <article v-for="item in relatorioMensal" :key="item.mes_ref" class="mei-card">
            ...
            <div class="mei-line">
              <span>Receita do MEI</span>
              <strong class="c-green">{{ R$(item.receitas_mei) }}</strong>
            </div>
            <div class="mei-line">
              <span>Despesas operacionais</span>
              <strong class="c-red">{{ R$(item.saidas_operacionais) }}</strong>
            </div>
            <div class="mei-line">
              <span>Retiradas/pessoal</span>
              <strong>{{ R$(item.saidas_pessoais) }}</strong>
            </div>
            <div class="mei-line">
              <span>Rendimento financeiro</span>
              <strong>{{ R$(item.rendimento_financeiro) }}</strong>
            </div>
...
async function onFileChange(event) {
  ...
  try {
    ...
    s.notify(`Extrato importado com ${resumo.importados} lancamento(s)!`)
  } catch (error) {
    console.error(error)
